package com.alvarolc.pmpd_playground.ut3.domain
...
class TapaModel(val titleRestaurant: Int = R.string.text_title_restaurant,
                ...
                val textViewOpinions: Int = R.string.text_view_opinions,
                val textAvailableCurrency: Int = R.string.text_available_currency,
                val textDiscountNumber: Int = R.string.text_discount_number) {
}
